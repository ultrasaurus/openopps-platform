...
const volunteerQuery = 'select task.id, task.title, volunteer."userId", midas_user.name as ownername, midas_user.username as ownerusername, m2.name as name, m2.username as username ' +
